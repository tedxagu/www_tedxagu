...
$avia_elements[] =	array(
					...
					<!--<small class='text_small_outside'>Next Event: in 10 hours 5 minutes.</small>-->
						...
						<div class='live-header_color border'>
							<h3 class='heading'>Logo Area Heading</h3>
...
$avia_elements[] =	array(
					"slug"	=> "header",
					"name" 	=> __("Seperator between menu items", 'avia_framework'),
					...
					"no_first"=>true,
					"subtype" => array( __('No seperator', 'avia_framework')  =>'',
										__('Small seperator', 'avia_framework') =>'seperator_small_border',
										__('Large seperator', 'avia_framework') =>'seperator_big_border',
										));
